...
function setupDb() {
  ...
  db.connect((error) => {
    ...
    db.query(
      'CREATE TABLE IF NOT EXISTS user(userID INT NOT NULL PRIMARY KEY, name VARCHAR(20), \
      mobile VARCHAR(20))',
      (err, results) => {
    ...
    db.query(
      'CREATE TABLE IF NOT EXISTS theatre(theatreID INT NOT NULL PRIMARY KEY, \
    ...
    db.query(
      'CREATE TABLE IF NOT EXISTS event(eventID INT NOT NULL PRIMARY KEY, duration VARCHAR(20),\
    ...
    db.query(
      'CREATE TABLE IF NOT EXISTS screen(screenID INT NOT NULL PRIMARY KEY, capacity INT, theatreID INT,\
  ...
  ro VARCHAR(20), screenID INT, CONSTRAINT fk_screen FOREIGN KEY (screenID) REFERENCES screen(screenID))',
    ...
    db.query(
      'CREATE TABLE IF NOT EXISTS shows(showID INT NOT NULL PRIMARY KEY, time datetime, date date, \
    ...
    db.query(
      'CREATE TABLE IF NOT EXISTS ticket(ticketID INT NOT NULL PRIMARY KEY, no_seats INT, userID INT, showID INT,\
